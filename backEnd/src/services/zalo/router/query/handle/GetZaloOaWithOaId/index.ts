...
class Handle_GetZaloOaWithOaId {
    ...
    checkRole = (req: Request<any, any, GetZaloOaWithOaIdBodyField>, res: Response, next: NextFunction) => {
        const getZaloOaWithOaIdBody: GetZaloOaWithOaIdBodyField = req.body;

        const myResponse: MyResponse<ZaloOaField> = {
            isSuccess: false,
            message: 'Bắt đầu (Handle_GetZaloOaWithOaId-checkRole) !',
        };
        ...
        if (typeof refreshToken === 'string') {
            ...
            const accountId = getZaloOaWithOaIdBody.accountId;
            if (id === accountId) {
    ...
    main = async (req: Request<any, any, GetZaloOaWithOaIdBodyField>, res: Response) => {
        const role: accountType_type = res.locals.role as accountType_type;
        const zaloOaWithOaIdBody: GetZaloOaWithOaIdBodyField = req.body;
        // const id = zaloOaWithIdBody.id;

        const myResponse: MyResponse<ZaloOaField> = {
            isSuccess: false,
            message: 'Bắt đầu (Handle_GetZaloOaWithOaId-main) !',
        };
        ...
        const queryDB = new QueryDB_GetZaloOaWithOaId();
        queryDB.setGetZaloOaWithOaIdBody(zaloOaWithOaIdBody);
...
export default Handle_GetZaloOaWithOaId;
