import { consumeStringMessage, consumeStatistics } from '@src/messageQueue/Consumer';
import {
    AddSalesBodyField,
...
function handleStatistics() {
    ...
    consumeStringMessage(`statistics${prefix}`, async (msg) => {
        const _msg = JSON.parse(msg) as UpdateStatisticsBodyField;
        const updateStatisticsBody: UpdateStatisticsBodyField = { ..._msg, ofDay: new Date(_msg.ofDay) };
