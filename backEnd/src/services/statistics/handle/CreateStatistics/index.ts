...
import MutateDB_CreateStatistics from '../../mutateDB/CreateStatistics';

export async function createStatistics(body: CreateStatisticsBodyField) {
    await mssql_server.init();

    const mutateDB = new MutateDB_CreateStatistics();
    mutateDB.setCreateStatisticsBody(body);
