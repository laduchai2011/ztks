...
import { use_leave_All_Account_Receive_Message_Mutation } from '@src/redux/query/account_RTK';
...
const LeaveAllAccountReceiveMessage = () => {
    ...
    const [leave_All_Account_Receive_Message] = use_leave_All_Account_Receive_Message_Mutation();
