...
const TextEditor: FC<{ value?: string; onChange?: (value: string) => void }> = ({ value, onChange }) => {
    ...
    const handleFormat = (cmd: format_type, e?: React.ChangeEvent<HTMLSelectElement>) => {
        switch (cmd) {
            ...
            case format_enum.FONT_SIZE: {
                ...
                const fontSize = sizeMap[e.target.value];

                if (!fontSize) break;

                toggleText('span', { fontSize });
                break;
            }
            default: {
                //statements;
            ...
            <div className={style.header}>
                <div className={style.btnContainer} ref={btnContainer_element}>
                    ...
                    {/* <select
                        ...
                        defaultValue={'0'}
                        onChange={(e) => handleFormat(format_enum.FONT_SIZE, e)}
                    >
                    ...
                    <select
                        className="te-formats select"
                        defaultValue={'0'}
                        onChange={(e) => handleFormat(format_enum.FORMAT_BLOCK, e)}
                    >
