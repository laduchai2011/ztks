...
import { My_Response_Field } from '@src/dataStruct_v1/response';
import { Account_Information_Field } from '@src/datastruct_v1/account';
import { Add_Member_V1_Body_Field } from '@src/dataStruct_v1/account/body';
...
class Handle_Add_Member_V1 {
    setup = async (req: Request<any, any, Add_Member_V1_Body_Field>, res: Response, next: NextFunction) => {
        ...
        if (typeof refreshToken === 'string') {
            ...
            add_member_v1_body.added_by_id = id.toString();
