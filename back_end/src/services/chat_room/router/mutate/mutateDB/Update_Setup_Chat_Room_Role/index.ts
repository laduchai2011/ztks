...
class MutateDB_Update_Setup_Chat_Room_Role {
    ...
    set_Update_Setup_Chat_Room_Role_Body(update_setup_chat_room_role_body: Update_Setup_Chat_Room_Role_Body_Field): void {
    ...
    async run(): Promise<Chat_Room_Role_Field | undefined> {
        if (this._update_setup_chat_room_role_body !== undefined) {
            ...
            try {
                ...
                const result = await pool.query<Chat_Room_Role_Field>(`SELECT * FROM update_setup_chat_room_role($1, $2, $3, $4, $5);`, [
